...
/* harmony default export */ __webpack_exports__["default"] = ("ion-menu-button {\n  color: var(--ion-color-primary);\n}\n\n#container {\n  text-align: center;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n#container strong {\n  font-size: 20px;\n  line-height: 26px;\n}\n\n#container p {\n  font-size: 16px;\n  line-height: 22px;\n  color: #8c8c8c;\n  margin: 0;\n}\n\n#container a {\n  text-decoration: none;\n}\n\n.letterinicio {\n  letter-spacing: -1px;\n  font-size: 16px !important;\n  font-weight: 600 !important;\n  color: #1b1b1b;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n\n<ion-content [fullscreen]=\"true\">\n\n\n  <app-back></app-back>\n  <app-header></app-header>\n\n\n<br><br><br><br><br><br><br><br><br><br>\n\n<div *ngIf=\"this.router.url === '/folder/Inbox'\"> \n<ion-item lines=\"none\">\n  <label>\n    <h1 class=\"letterinicio margin-bottom-3 \">Popular Song</h1>\n  </label>\n  </ion-item>\n</div>\n\n<ion-slides class=\"swiper-container\" pager= false [options]=\"slideOption\" #slidesOne>\n\n  <ion-slide *ngFor=\"let category of categories | async \" (click)=\"openDetail('music-list',category.id)\">\n    <ion-card class=\"music-main-h-card music-card2 slide-left fade-in-left\"  >\n          <div class=\"music-card2-bg ion-text-uppercase\" [ngStyle]=\"{'background-image': 'url(' + category.image+ ')'}\" >\n              <h2 class=\"card2-title\"> {{category.name}}</h2>                           \n          </div>\n    </ion-card>\n  </ion-slide>\n</ion-slides>\n  \n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">{{ folder }}</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <div id=\"container\">\n    <strong class=\"capitalize\">{{ folder }}</strong>\n    <p>Explore <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://ionicframework.com/docs/components\">UI Components</a></p>\n  </div>\n</ion-content>\n");
...
let FolderPage = class FolderPage {
    ...
    getCategory() {
        this.categories = this.musicservice.getCategories();
    }
    ngOnInit() {
...
/* harmony import */ var _components_back_back_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/back/back.component */ "+Ab6");
...
FolderPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_folder_page__WEBPACK_IMPORTED_MODULE_6__["FolderPage"], _components_back_back_component__WEBPACK_IMPORTED_MODULE_7__["BackComponent"], _components_header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"]]
    })
], FolderPageModule);
